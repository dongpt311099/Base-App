...
public final class DialogExitBinding implements ViewBinding {
  ...
  private DialogExitBinding(@NonNull LinearLayout rootView, @NonNull TextView allowBtn,
      @NonNull TextView cancelBtn) {
  ...
  public static DialogExitBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.allowBtn;
      TextView allowBtn = ViewBindings.findChildViewById(rootView, id);
      if (allowBtn == null) {
        break missingId;
      }
      ...
      return new DialogExitBinding((LinearLayout) rootView, allowBtn, cancelBtn);
    }
